class DropBoxController{
  ...
  connectFireBase(){
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyBc81kv-DbAm-kUl8hNnuhGn0AeREvGcRk",
      authDomain: "dropbox-clone-ac011.firebaseapp.com",
      databaseURL: "https://dropbox-clone-ac011-default-rtdb.firebaseio.com",
      projectId: "dropbox-clone-ac011",
      storageBucket: "dropbox-clone-ac011.appspot.com",
      messagingSenderId: "303737361371",
      appId: "1:303737361371:web:2a88beba34a0b4c84c0dfe"
    };
  ...
  initEvents(){
      ...
      this.btnRename.addEventListener('click', e =>{
          ...
          let file = JSON.parse(li.dataset.file);
          // json.parse transforma a string em json
  ...
  getFileView(file, key){
      ...
      li.dataset.key = key;
      // com dataset o js consegue "pegar" melhor
  ...
  readFiles(){
      ...
      this.getFirebaseRef().on('value', snapshot =>{
          ...
          snapshot.forEach(snapshotItem =>{
              ...
              // appendiChild precisa ser retorno de elemento
      ...
      li.addEventListener('click', e => {
          ...
          if(e.shiftKey){
              ...
              if(firstLi){
                  ...
                  //.sort coloca o array de forma ordenada 
          ...
          if(!e.ctrlKey){
          // Não estava segurando crtl 

              this.listFilesEl.querySelectorAll('li.selected').forEach(el=>{

                  el.classList.remove('selected');
                  // remove 1 por 1 os selecionados 
          ...
          // essa class CSS vai deixar selecionar o elemento que ocorreu o click
